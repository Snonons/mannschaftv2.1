...
CREATE ROLE mannschaft LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE mannschaft;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE mannschaft TO mannschaft;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE mannschaftspace OWNER mannschaft LOCATION '/var/lib/postgresql/tablespace/mannschaft';
