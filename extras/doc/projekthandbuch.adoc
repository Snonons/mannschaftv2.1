...
.Use Cases für den Microservice "mannschaft"
...
.Die Klasse "MannschaftModel" für den Datenaustausch bei GET
[plantuml,MannschaftModel,svg]
----
include::./MannschaftModel.plantuml[]
----
...
.Die Klasse "MannschaftUserDTO" für den Datenaustausch bei POST
[plantuml,MannschaftUserDTO,svg]
----
include::./MannschaftUserDTO.plantuml[]
----
