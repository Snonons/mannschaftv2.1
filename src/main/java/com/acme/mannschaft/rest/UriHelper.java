...
class UriHelper {
    ...
    private static final String MANNSCHAFTEN_PREFIX = "/mannschaften";
    ...
    private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
        ...
        // x-forwarded-prefix: null bei Kubernetes Ingress Controller bzw. "/mannschaften" bei Spring Cloud Gateway
        if (forwardedPrefix == null) {
            log.trace("getBaseUriForwarded: Kein \"{}\" im Header", X_FORWARDED_PREFIX);
            forwardedPrefix = MANNSCHAFTEN_PREFIX;
        }
