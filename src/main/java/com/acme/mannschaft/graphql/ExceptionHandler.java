...
import com.acme.mannschaft.service.NotFoundException;
...
final class ExceptionHandler {
    ...
    GraphQLError onNotFound(final NotFoundException ex) {
        ...
        final var message = id == null
            ? STR."Kein Mannschaft gefunden: suchkriterien=\{ex.getSuchkriterien()}"
            : STR."Kein Mannschaft mit der ID \{id} gefunden";
