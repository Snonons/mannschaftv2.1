...
//        .\build\native\nativeCompile\mannschaft.exe --spring.profiles.active=dev --logging.file.name=.\build\log\application.log
//        .\build\native\nativeCompile\mannschaft.exe --spring.datasource.url=jdbc:h2:mem:testdb --spring.datasource.username=sa --spring.datasource.password="" --logging.file.name=.\build\log\application.log
//
...
val imagePath = project.properties["imagePath"] ?: "jensmartin"
...
dependencyCheck {
    ...
    nvd(
        closureOf<org.owasp.dependencycheck.gradle.extension.NvdExtension> {
            ...
            // default: 2000 Millisemannschaftn Wartezeit zwischen den Aufrufen an das NVD API bei einem API-Key, sonst 8000
            //delay = 5000
